...
from clusvpr.utils.data.sampler import DistributedSliceSampler
...
from clusvpr.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict, write_json
from clusvpr.utils.dist_utils import init_dist, synchronize
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="ClusVPR testing")
