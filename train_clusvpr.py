...
from clusvpr.trainers import ClusVPRTrainer
from clusvpr.evaluators import Evaluator, extract_features, pairwise_distance
from clusvpr.utils.data import IterLoader, get_transformer_train, get_transformer_test
from clusvpr.utils.data.sampler import DistributedRandomDiffTupleSampler, DistributedSliceSampler
from clusvpr.utils.data.preprocessor import Preprocessor
from clusvpr.utils.logging import Logger
from clusvpr.pca import PCA
from clusvpr.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict
from clusvpr.utils.dist_utils import init_dist, synchronize, convert_sync_bn
from clusvpr.utils.rerank import re_ranking
...
def get_model(args):
    ...
    pool_layer = models.create('clusvpr', dim=base_model.feature_dim, num_clusters=args.num_clusters)
...
def main_worker(args):
    ...
    # Trainer
    trainer = ClusVPRTrainer(model, model_cache, margin=args.margin**0.5,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="ClusVPR training")
